...
#include <cstdint>
namespace ap {
enum class RmStage {Disabled,Observe,Readonly,Active};
...
struct ProfileState {
    ...
    uint64_t application_rm_controls_observed=0,project_controls_attempted=0,project_active_controls_attempted=0;
